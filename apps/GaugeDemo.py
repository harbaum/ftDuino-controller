...
def __llvgl_task_0(__timer):
    ...
    widget_set_value(object2,[50 + 50 * math.sin(value / 180.0 * math.pi), 50 + 25 * math.cos(value / 180.0 * math.pi), (ftduino.i2c_read(i2cBus, 43, ftduino.INPUT_VALUE.I1, ftduino.I2C_TYPE.INT16LE, 1)) / 47])
    value = value + 1
